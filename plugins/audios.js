export const handler = async (m, { sock, command }) => {
  ...
  try {
    ...
    if (!jid) return console.log('❌ JID inválido')
    ...
    const audios = {
      ...
      esviernes: 'https://qu.ax/LcdD.mp3',
      feriado: 'https://qu.ax/mFCT.mp3',
      delibery: 'https://qu.ax/WGzN.mp3',
      aguanta: 'https://qu.ax/Qmz.mp3',
      moshi: 'https://qu.ax/JAyd.mp3',
      nadie: 'https://qu.ax/MrGg.mp3',
      navidad: 'https://cdn.russellxz.click/2d8778d7.mp3',
      niconico: 'https://qu.ax/YdVq.mp3',
      nochupala: 'https://qu.ax/iCRk.mp3',
      nomehables: 'https://qu.ax/xxtz.mp3',
      nomehagas: 'https://qu.ax/bzDa.mp3',
      nodigas: 'https://qu.ax/jsb.mp3',
      nochedepaz: 'https://cdn.russellxz.click/8e6bd672.mp3',
      ...
      peroesto: 'https://qu.ax/javz.mp3',
      pikachu: 'https://qu.ax/wbAf.mp3',
      pokemon: 'https://qu.ax/kWLh.mp3',
      botsito: 'https://qu.ax/uyqQ.mp3',
      ...
      engañe: 'https://qu.ax/yTid.mp3',
      novios: 'https://cdn.russellxz.click/9e1167d5.mp3',
...
handler.command = [
  ...
  'pato','viernes','wtf','yokese','vrg','pubrio','temazo','freefire','esviernes',
  'feriado','delibery','aguanta','moshi','nadie','navidad','niconico','nochupala',
  'nomehables','nomehagas','nodigas','nochedepaz','omg','onichan','orale','pack',
  'contexto','peroesto','pikachu','pokemon','botsito','rawr','hablame','cagaste',
  'yoshi','engañe','novios','yamete','detenido','pregunta','chiste'
]
