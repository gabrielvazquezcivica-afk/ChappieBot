...
export const handler = async (m, { sock, from, isGroup, reply }) => {
  ...
  const text = rawText?.replace('.setbye', '').trim()
  if (!text) return reply('⚠️ Debes escribir un mensaje para la despedida')
  ...
  reply('✅ Mensaje de despedida personalizado guardado')
}
